...
VENDOR_SKIP_FILES=(
    ...
    "etc/bluetooth_power_limits_GKWS6_CA.csv"
    "etc/bluetooth_power_limits_GKWS6_EU.csv"
    "etc/bluetooth_power_limits_GKWS6_JP.csv"
    "etc/bluetooth_power_limits_GKWS6_US.csv"
    ...
    "etc/display_colordata_google-bigsurf_cal0.pb"
    "etc/display_colordata_google-shoreline_cal0.pb"
    "etc/display_golden_google-bigsurf_cal0.pb"
    "etc/display_golden_google-shoreline_cal0.pb"
    "etc/fs_config_dirs"
    "etc/fs_config_files"
    "etc/fstab.modem"
    "etc/fstab.persist"
    ...
    "etc/modem/camera_front_dbr_coex_table.csv"
    ...
    "etc/modem/extensive_logging.conf"
    "etc/modem/logging.conf"
    "etc/modem_ml_models.conf"
    "etc/panel_config_google-bigsurf_cal0.pb"
    "etc/panel_config_google-shoreline_cal0.pb"
    "etc/passwd"
    ...
    "etc/radio/log_masks/default/default_modem_log_mask.xml"
    "etc/radio/log_masks/empty/empty_modem_log_mask.cfg"
    "etc/radio/log_masks/empty/empty_modem_log_mask.conf"
